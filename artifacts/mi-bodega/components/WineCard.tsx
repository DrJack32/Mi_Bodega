  ...
  return (
    ...
    >
      <View style={styles.photoContainer}>
        ...
        <View style={[styles.typeBadge, { backgroundColor: typeColor }]}>
          <Text style={styles.typeText}>
            {WINE_TYPE_LABELS[wine.type] ?? "Otro"}
          </Text>
        </View>
      </View>
      ...
      <View style={styles.info}>
        ...
        {wine.winery ? (
          <Text
            style={[styles.winery, { color: colors.mutedForeground }]}
            numberOfLines={1}
          >
            {wine.winery}
          </Text>
...
const styles = StyleSheet.create({
  ...
  countRow: { flexDirection: "row", flexWrap: "wrap", gap: 5, marginTop: 3 },
  countBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 3,
  ...
  countText: { fontSize: 9, fontFamily: "Inter_600SemiBold" },
  footer: {
    flexDirection: "row",
